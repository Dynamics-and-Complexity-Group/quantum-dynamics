...
process from the right to the left well.
...
def plot_mean_position_and_variance(psi_data, x, dx, dt, filename='mean_position_variance_plot.png', dpi=150):
    """
    ...
    ax1.set_title("Mean Position and Variance over Time")
    ...
    # Plot variance vs time (bottom subplot)
...
def main(x_in = 5.5, var_val = 0.3,E_target=12):
    ...
    # --- Plot and Save Mean Position ---
    plot_mean_position_and_variance(psi_data, x, dx, dt, filename=f'asymetric_double_well_simulation_data_right_well_{energy_str}.png', dpi=150)
#################################################################################################################################################
#################################################################################################################################################
...
if __name__ == "__main__":
    ...
    main(x_in = 5.5, var_val = 0.1, E_target = 12.55) # Gives E = 13.6834 = 4.68 + 9.0034
    main(x_in = 5.5, var_val = 0.1, E_target = 18.5) # Give E = 19.6333 = 4.68 + 14.9533
